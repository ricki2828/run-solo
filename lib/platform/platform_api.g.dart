...
class Preset {
  ...
  List<Object?> _toList() {
    return <Object?>[reps, workSeconds, recoverySeconds];
  }
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(reps, other.reps) &&
        _deepEquals(workSeconds, other.workSeconds) &&
        _deepEquals(recoverySeconds, other.recoverySeconds);
  }
...
class RecorderApi {
  ...
  Future<StartResult> startReplay(
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(
      <Object?>[mode, preset, units, replay],
    );
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
...
class PermissionsApi {
  ...
  Future<bool> requestIgnoreBatteryOptimizations() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.run_solo.PermissionsApi.requestIgnoreBatteryOptimizations$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
